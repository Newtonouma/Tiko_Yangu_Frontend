...
const Footer = () => {
  ...
  const toggleAccordion = (sectionTitle: string) => {
    setOpenAccordion(openAccordion === sectionTitle ? null : sectionTitle);
  };

  const footerSections: AccordionSection[] = [
    {
      title: 'Events',
      links: [
        { name: 'Browse Events', href: '/events' },
        { name: 'Create Event', href: '/dashboard/events/create' },
        { name: 'Event Categories', href: '/events?filter=categories' },
        ...
        <div className={styles.desktopLayout}>
          ...
          <div className={styles.companySection}>
            ...
            <p className={styles.description}>
              Your premier event ticketing platform. Discover amazing events and book tickets seamlessly.
            </p>
            ...
            <div key={section.title} className={styles.accordionSection}>
              <button
                className={`${styles.accordionHeader} ${
                  openAccordion === section.title ? styles.accordionHeaderOpen : ''
                }`}
              ...
              >
                ...
                <svg
                  className={`${styles.accordionIcon} ${
                    openAccordion === section.title ? styles.accordionIconOpen : ''
                  }`}
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
              ...
              <div
                className={`${styles.accordionContent} ${
                  openAccordion === section.title ? styles.accordionContentOpen : ''
                }`}
              >
                <ul className={styles.linkList}>
                  {section.links.map((link) => (
